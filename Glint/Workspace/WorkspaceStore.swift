...
struct WorkspaceTab: Identifiable, Codable {
    ...
    /// Current agent identity ("claude"/"codex") for this tab,
...
struct Workspace: Identifiable, Codable {
    ...
    var symbol: String
    /// Current agent identity ("claude"/"codex") mirrored from
...
extension WorkspaceStore {
    ...
    /// so a previous Claude/Codex session does not stick forever.
